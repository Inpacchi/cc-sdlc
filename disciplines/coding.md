...
**Knowledge store**: `[sdlc-root]/knowledge/coding/` (code quality principles, TypeScript patterns)
...
The most impactful coding discipline is structural: **separate I/O from logic**. This is the Functional Core, Imperative Shell pattern. See `[sdlc-root]/knowledge/testing/testing-paradigm.yaml` for the full treatment.
